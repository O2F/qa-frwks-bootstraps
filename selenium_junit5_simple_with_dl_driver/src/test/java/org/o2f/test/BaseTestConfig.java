...
public class BaseTestConfig {
    ...
    private static String propReportPath;
    ...
    static {
        ...
        try (InputStream input = BaseTestConfig.class.getClassLoader().getResourceAsStream(configFile)) {
            ...
            if (input == null) {
                ...
                propReportPath = prop.getProperty("report.path");
            }
        ...
        final String reportPath = requireNonNull(System.getProperty(REPORT_PATH,propReportPath),"Report path not found");
        ...
        testConfig = BaseConfigModel
                ...
                .baseUrl(baseUrl)
                .browser(browser)
                .reportConfigModel(BaseConfigModel.ReportConfigModel
                        .builder()
